...
<head>
    @php
        ...
        $includeTheme = true;
    @endphp
    <?php include base_path('redmine-mantencion/views/partials/bootstrap-head.php'); ?>
</head>
...
@endphp
<?php include base_path('redmine-mantencion/views/partials/navbar.php'); ?>
...
<?php include base_path('redmine-mantencion/views/partials/bootstrap-scripts.php'); ?>
<script>
(function () {
