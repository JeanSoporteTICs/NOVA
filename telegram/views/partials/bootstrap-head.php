...
$pageTitle = $pageTitle ?? 'Telegram';
$h = $h ?? static fn($value): string => htmlspecialchars((string) $value, ENT_QUOTES, 'UTF-8');
$moduleBaseUrl = function_exists('url') ? rtrim(url('/telegram'), '/') : '/telegram';
...
$themePath = __DIR__ . '/../../assets/theme.css';
$themeVersion = @filemtime($themePath) ?: time();
