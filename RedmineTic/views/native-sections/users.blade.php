    ...
    <div class="modal-dialog modal-dialog-centered" style="max-width:420px">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p class="small nova-muted mt-2 mb-0">Solo se quitará su acceso al módulo. El usuario central en NOVA y su perfil TIC no se borrarán.</p>
            </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12" data-edit-role-note hidden>
                        <div class="alert alert-info mb-0">
                            ...
                            En edición solo se modifica el rol dentro del proyecto. La identidad, estado e integraciones personales se mantienen sin cambios.
                        </div>
                    </div>
                </div>
            </div>
