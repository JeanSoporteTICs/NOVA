            ...
            <tr>
              ...
              <td class="d-flex gap-2 flex-wrap">
                ...
                <form method="post" data-app-confirm="¿Eliminar este usuario?" class="m-0">
                  ...
                  <input type="hidden" name="csrf_token" value="<?= $h($csrf) ?>">
                  <button class="btn btn-sm btn-outline-danger btn-icon" aria-label="Eliminar usuario" <?= $maintenanceMode ? 'disabled title="Plataforma en mantención"' : '' ?>><i class="bi bi-trash"></i> Eliminar</button>
                </form>
              </td>
            </tr>
          <?php endforeach; ?>
