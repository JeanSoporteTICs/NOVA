  ...
  function renderIdleDirectory() {
    ...
    el.innerHTML = `
      <div class="nc-empty">
        ...
        <div class="fw-semibold mb-2">Carpetas de Nextcloud listas para consultar.</div>
        <button type="button" class="btn btn-sm btn-primary" id="nc-load-btn">
          <i class="bi bi-cloud-arrow-down"></i> Cargar carpetas
        </button>
      </div>`;
    document.getElementById('nc-load-btn')?.addEventListener('click', () => loadDirectory(currentPath || '/'));
  }
