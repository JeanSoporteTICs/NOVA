...
auth_require_role(['root','administrador','gestor'], '/redmine_tic/login.php');
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'sync_unidades') {
  ...
  header('Location: /redmine_tic/?page=configuracion&synuni=' . urlencode($msg));
  exit;
}
?>
<!doctype html>
      ...
      <div class="modal-body modal-body-tight">
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center mb-3 gap-2">
          ...
          <div class="d-flex gap-2">
            <form action="/redmine_tic/?page=sync-categorias" method="post" class="m-0 d-inline" id="sync-cat-form">
              <input type="hidden" name="csrf_token" value="<?= $h($csrf) ?>">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body modal-body-tight">
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center mb-3 gap-2">
          ...
          <div class="d-flex gap-2">
            <form action="/redmine_tic/?page=configuracion" method="post" class="m-0 d-inline" id="sync-uni-form">
              <input type="hidden" name="csrf_token" value="<?= $h($csrf) ?>">
