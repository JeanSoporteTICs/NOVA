...
<div class="container-fluid py-4">
  ...
  <form class="card shadow-sm mb-3" method="get" action="/redmine_tic/">
    ...
    <div class="card-body row g-3 align-items-end">
      ...
      <div class="col-md-4 col-lg-3 d-flex gap-2">
        ...
        <a class="btn btn-outline-secondary" href="/redmine_tic/?page=horas-extra"><i class="bi bi-x-circle"></i> Limpiar</a>
      </div>
    </div>
  </form>
