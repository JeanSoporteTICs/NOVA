...
$priorityScopeQuery = trim($_GET['priority_scope'] ?? 'all');
...
$priorityFilter = null;
if ($priorityScopeQuery === 'all' || $priorityScopeQuery === '') {
  $prioritySelection = 'all';
  $priorityFilter = null;
...
$statusScopeQuery = trim($_GET['status_scope'] ?? 'all');
$estados = $cfg['estados'] ?? [];
$availableStatusIds = array_values(array_unique(array_filter(array_map(fn($e) => (string)($e['id'] ?? ''), $estados))));
$allowedScopes = array_merge(['open', 'closed', 'all'], $availableStatusIds);
...
// Redmine API debe consultar Redmine, no reutilizar datos de Estadisticas locales.
// El cache solo se usa al guardar seleccion de categorias luego de una consulta.
$tabla          = [];
$tablaUnidades  = [];
$totalGlobal    = 0;
$totalUnidades  = 0;
...
<div id="page-content">
  <div class="container-fluid py-4">
    <?php
      ...
      $heroTitle   = 'Redmine API';
      $heroSubtitle= 'Consulta directa a Redmine solo cuando presionas el botón de obtener datos.';
      ob_start(); ?>
      <form id="range-form" class="d-flex flex-wrap gap-2 align-items-end" method="get" action="/redmine_tic/">
        ...
        <div>
          <a class="btn btn-sm btn-outline-light mt-2" href="/redmine_tic/?page=estadisticas-api">Limpiar</a>
        </div>
        <div class="w-100"></div>
        ...
        <div class="card-header d-flex align-items-center justify-content-between flex-wrap gap-2">
          ...
          <div class="d-flex align-items-center gap-3 flex-wrap">
            ...
            <div class="form-check form-check-inline m-0">
              ...
              <label class="form-check-label small" for="chart-show-values">Mostrar totales sobre puntos</label>
            </div>
          </div>
        </div>
    ...
    <div class="modal fade" id="chartUnitsModal" tabindex="-1" aria-hidden="true">
      ...
      <div class="modal fade" id="selCatModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-scrollable">
          <form class="modal-content" method="post" id="sel-cat-form" action="/redmine_tic/?page=estadisticas-api">
            <div class="modal-header">
  ...
  <script src="/redmine_tic/assets/js/chart.umd.min.js"></script>
  <script>
    ...
    return new Chart(ctx, {
      ...
      data: {
        ...
        datasets: [{
          ...
          pointRadius: isFull ? 3.5 : 2.5,

          pointHoverRadius: isFull ? 5 : 4,
      ...
      options: {
        ...
        scales: {
          x: {
            ...
            ticks: {
              maxRotation: isFull ? 45 : 35,
              minRotation: isFull ? 20 : 25,
              color: '#6b7280',
