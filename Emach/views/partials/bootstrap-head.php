...
?>
  ...
  <script src="<?= $h(function_exists('asset') ? asset('assets/nova-sidebar-preload.js') : '/NOVA/public/assets/nova-sidebar-preload.js') ?>?v=<?= (int) $novaSidebarPreloadVersion ?>" data-nova-sidebar-key="emach"></script>
