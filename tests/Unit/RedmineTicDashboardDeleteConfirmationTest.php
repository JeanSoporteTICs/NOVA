...
final class RedmineTicDashboardDeleteConfirmationTest extends TestCase
{
    ...
    public function test_dashboard_editor_uses_select2_and_defaults_to_the_active_session_user(): void
    {
        ...
        self::assertStringContainsString('let modalBackdropPointerTarget = null;', $layout);
        self::assertStringContainsString('modalBackdropPointerTarget === modal', $layout);
        self::assertStringContainsString('if (startedOnBackdrop && modal.dataset.novaSessionModal', $layout);
